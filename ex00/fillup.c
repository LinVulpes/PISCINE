...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/07/02 16:56:56 by thmu              #+#    #+#             */
/*   Updated: 2023/07/02 16:56:58 by thmu             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		leftright(int check, int *attr, int grid[4][4], int arr[4][4]);
int		updown(int check, int *attr, int grid[4][4], int arr[4][4]);
...
int	is_valid(int grid[4][4], int arr[4][4], int *attr)
{
	...
	if (leftright(0, attr, grid, arr) == 1)
		return (1);
	if (updown(0, attr, grid, arr) == 1)
		return (1);
